...
public class ModItems {
    ...
    public static final RegistryObject<Item> BACONIUM_INGOT = ITEMS.register("baconium_ingot", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> CHICKENITE_INGOT = ITEMS.register("chickenite_ingot", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> DECAYRON_INGOT = ITEMS.register("decayron_ingot", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> MUTTONIUM_INGOT = ITEMS.register("muttonium_ingot", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> PARAFISH_INGOT = ITEMS.register("parafish_ingot", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> RABBIDDIUM_INGOT = ITEMS.register("rabbiddium_ingot", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> STEAKITE_INGOT = ITEMS.register("steakite_ingot", () -> new Item(new Item.Properties()));
    ...
    public static final RegistryObject<Item> FULLFILLING_FOODIUM_PIE = ITEMS.register("fullfilling_foodium_pie", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> HEAVYWEIGHT_MEAL = ITEMS.register("heavyweight_meal", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> LIGHTWEIGHT_MEAL = ITEMS.register("lightweight_meal", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> PARAFISH_MEAL = ITEMS.register("parafish_meal", () -> new Item(new Item.Properties()));
